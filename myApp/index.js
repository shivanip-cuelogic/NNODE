...
var deleteAllUSers = require("./controller/admin/deleteallUsers");
var editAllUsers = require("./controller/admin/editallUsers");
...
//delete of all
app.use('/admin/deleteAll',deleteAllUSers);

//edit all users
app.use('/admin/editAll',editAllUsers);
